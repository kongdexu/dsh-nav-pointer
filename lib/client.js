window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var CSS = [
      ...
      ".dsh-msg-marker.type-code > i{background:var(--dsw-static-amber-500,#f59e0b);height:6px;border-radius:1px}",
      ".dsh-msg-marker.type-code:hover > i{background:var(--dsw-static-amber-400,#fbbf24)}",
      ".dsh-msg-marker.type-code.active > i{background:var(--dsw-static-deepseek-500)}",
      ".dsh-msg-marker.type-image > i{background:var(--dsw-static-green-500,#10b981);height:6px;border-radius:50%}",
      ".dsh-msg-marker.type-image:hover > i{background:var(--dsw-static-green-400,#34d399)}",
      ".dsh-msg-marker.type-image.active > i{background:var(--dsw-static-deepseek-500)}",
